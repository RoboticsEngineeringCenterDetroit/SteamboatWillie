...
public class RobotMap {
    ...
    public static CANSpeedController blenderMotor;
    public static CANSpeedController intakeMotor;
    
    public static CANSpeedController climberMotor;
